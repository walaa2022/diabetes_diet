...
# Ensure API key is correctly passed as a string
api_key = ["api_key"]  # Ensure no extra spaces

# If the API key is still a list, take the first element (this is a workaround)
...
if st.sidebar.button("Generate Meal Plan"):
    ...
    if meal_plan:
        ...
        st.write("Sorry, an error occurred while generating your meal plan.")